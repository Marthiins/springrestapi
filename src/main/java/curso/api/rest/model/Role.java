...
@Entity /*Tornar a tabela no banco de dados*/
@Table(name = "role")
@SequenceGenerator(name = "seq_role", sequenceName ="seq_role", allocationSize = 1, initialValue = 1)/*começa de 1 e vai de 1 em 1*/
